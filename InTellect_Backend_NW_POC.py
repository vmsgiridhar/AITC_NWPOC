...
connString = 'DRIVER={HDBODBC};SERVERNODE=vhmcdbfadb.mcd.rot.hec.sap.biz:30415;SERVERDB=BFA;UID=C5232886;PWD=Giri2017@Bfa'
...
for i in trainrows:
    ...
    if i.COMP_TRAIN == ticket_category_dict[0]:
        ticket_train_target.append(0)
    if i.COMP_TRAIN == ticket_category_dict[1]:
        ticket_train_target.append(1)
    if i.COMP_TRAIN == ticket_category_dict[2]:
